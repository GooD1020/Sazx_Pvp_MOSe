...
local Properties = {
    ...
    CircleButton = {
        BackgroundTransparency = 1,
        AutoButtonColor = false,
        Image = "http://www.roblox.com/asset/?id=55548310"
    },
    Frame = {
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
...
function check.togfunction:unlock(tf)
            ...
            function alphafunction:Textbox(text,text2,default,callback)
            ...
            function alphafunction:MultiDropdown(text,use,option,callback)
                ...
                TextLabel_TapDrop.RichText = true
            ...
            function alphafunction:allstartog(logo,text1,text2,text3,config,callback)
                local PictureFrame = Instance.new("Frame")
                local PictureImage = Instance.new("ImageLabel")
                local PictureImageUICorner = Instance.new("UICorner")
                ...
                PictureFrame.Parent = ScrollingFrame_Pageframe
                PictureFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
                PictureFrame.BackgroundTransparency = 1.000
                PictureFrame.Size = UDim2.new(0, 100, 0, 100)

                PictureImage.Name = "PictureImage"
                PictureImage.Parent = PictureFrame
                PictureImage.Active = true
                PictureImage.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
                PictureImage.Size = UDim2.new(0, 100, 0, 100)
                PictureImage.Image = "http://www.roblox.com/thumbs/asset.ashx?width=50&height=50&assetId="..tostring(logo)

                local PictureImageUiStroke = Instance.new("UIStroke")

                PictureImageUiStroke.Thickness = 1
                PictureImageUiStroke.Name = ""
                PictureImageUiStroke.Parent = PictureImage
                PictureImageUiStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                PictureImageUiStroke.LineJoinMode = Enum.LineJoinMode.Round
                PictureImageUiStroke.Color = Color3.fromRGB(30,30,30)
                PictureImageUiStroke.Transparency = 0

                PictureImageUICorner.Name = "PictureImageUICorner"
                PictureImageUICorner.Parent = PictureImage

                TextMain.Name = "TextMain"
                TextMain.Parent = PictureFrame
                TextMain.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                TextMain.BackgroundTransparency = 1.000
                TextMain.Position = UDim2.new(1.10000002, 0, 0, 0)
                TextMain.Size = UDim2.new(0, 286, 0, 24)
                TextMain.Font = Enum.Font.Gotham
                TextMain.TextColor3 = Color3.fromRGB(62, 125, 188)
                TextMain.TextSize = 12.000
                TextMain.Text = tostring(text1)
                TextMain.TextWrapped = true
                TextMain.TextXAlignment = Enum.TextXAlignment.Left

                Toggle.Name = "Toggle"
                Toggle.Parent = PictureFrame
                Toggle.BackgroundColor3 = Color3.fromRGB(56, 112, 168)
                Toggle.BackgroundTransparency = 1.000
                Toggle.Position = UDim2.new(1.08000004, 0, 0.610409558, 0)
                Toggle.Size = UDim2.new(0, 292, 0, 37)
                ...
                ToggleUiStroke.Color = Color3.fromRGB(30,30,30)
                ToggleUiStroke.Transparency = 0

                TextToggle.Name = "TextToggle"
                TextToggle.Parent = Toggle
                TextToggle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                TextToggle.BackgroundTransparency = 1.000
                TextToggle.Position = UDim2.new(0.0239726026, 0, 0, 0)
                TextToggle.Size = UDim2.new(0, 232, 0, 37)
                TextToggle.Font = Enum.Font.Gotham
                TextToggle.TextColor3 = Color3.fromRGB(255, 255, 255)
                TextToggle.TextSize = 13.000
                TextToggle.TextTransparency = 0.6
                TextToggle.Text = tostring(text3)
                TextToggle.TextWrapped = true
                TextToggle.TextXAlignment = Enum.TextXAlignment.Left

                Corner1.Name = "Corner1"
                Corner1.Parent = Toggle
                Corner1.AnchorPoint = Vector2.new(0.5, 0.5)
                Corner1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                Corner1.Position = UDim2.new(0.899999976, 0, 0.5, 0)
                Corner1.Size = UDim2.new(0, 50, 0, 20)
                Corner1.AutoButtonColor = false
                Corner1.Font = Enum.Font.SourceSans
                Corner1.Text = ""
                ...
                TextDesc.Parent = PictureFrame
                TextDesc.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                TextDesc.BackgroundTransparency = 1.000
                TextDesc.Position = UDim2.new(1.10000002, 0, 0.300000012, 0)
                TextDesc.Size = UDim2.new(0, 286, 0, 24)
                TextDesc.Font = Enum.Font.Gotham
                TextDesc.TextColor3 = Color3.fromRGB(100, 100, 100)
                TextDesc.TextSize = 11.000
                TextDesc.Text = tostring(text2)
            ...
            function alphafunction:modelToggle(Model,text1,text2,text3,config,callback)
                local PictureFrame = Instance.new("Frame")
                local PictureImage = Instance.new("ImageLabel")
                local PictureImageUICorner = Instance.new("UICorner")
                local TextMain = Instance.new("TextLabel")
                ...
                PictureFrame.Name = "3dFrame"
                PictureFrame.Parent = ScrollingFrame_Pageframe
                PictureFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
                PictureFrame.BackgroundTransparency = 1.000
                PictureFrame.Size = UDim2.new(0, 100, 0, 100)

                PictureImage.Name = "3dImage"
                PictureImage.Parent = PictureFrame
                PictureImage.Active = true
                PictureImage.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
                PictureImage.Size = UDim2.new(0, 100, 0, 100)
                ...
                if Model:FindFirstChild("Humanoid") then
                    ...
                    ViewportFrame.Parent = PictureImage
                    ...
                    Camera.CFrame = Preview.Head.CFrame + Preview.Head.CFrame.LookVector
                    Camera.CFrame = CFrame.new(Camera.CFrame.Position,Preview.Head.Position)
                    ViewportFrame.CurrentCamera = Camera
                else
                    alphaui:Notification("3D Toggle Notifications","Cannot Found Model",4,"")
                end
...
return alphaui
local win = alphaui:Init("SAZX HUB |PVP MODE ",9039412253)
local GeneralTab = win:Tab("General",9039412253)
local Tab1 = GeneralTab:Page("Main")

Tab1:Toggle("Aimbot สกิลดาบผล ละ ปืน",90212910,false,function(value)

		_G.Aimvotskillgun  = value

	end)
	
	Tab1:Toggle("Show Fov",8919201,false,function(value)
		_G.ShowFov = value
	end)
	
	_G.FOVSize = 200
	
	Tab1:Slider("Fov ใหญ่"8129102,,1,700,200,function(value)
		_G.FOVSize = value
	end)
	
	Tab1:Slider("Fov Thickness",8029192,1,100,2,function(value)
		_G.Thicknessz = value
	end)
	
	Tab1:Toggle("Start Bounty Farm",7041910,nil,function(value)
